...
import com.intra.time.model.FooModel;
import com.intra.time.model.FooSoap;
...
public class FooModelImpl extends BaseModelImpl<Foo> implements FooModel {
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.intra.time.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.intra.time.model.Foo"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.intra.time.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.intra.time.model.Foo"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.intra.time.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.intra.time.model.Foo"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.intra.time.service.util.ServiceProps.get(
				"lock.expiration.time.com.intra.time.model.Foo"));
	...
	public String toXmlString() {
		...
		sb.append("com.intra.time.model.Foo");
